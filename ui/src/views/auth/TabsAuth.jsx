              ...
              <Col>
                <Card.Body className="card-body">
                  ...
                  <div className={blockSignInClass.join(' ')}>
                    <ol className="position-relative carousel-indicators justify-content-center mb-3" style={{ listStyleType: 'none' }}>
                      <li className={authSignInClass} onClick={() => setIsAuth(true)} onKeyDown={() => setIsAuth(true)} />
                      <li className={authSignUpClass} onClick={() => setIsAuth(false)} onKeyDown={() => setIsAuth(false)} />
                    </ol>
                    ...
                    <button className="btn  btn-primary mb-4 me-2">Signin</button>
                  ...
                  <div className={blockSignUpClass.join(' ')}>
                    ...
                    <button className="btn  btn-primary mb-4 me-2">Signup</button>
