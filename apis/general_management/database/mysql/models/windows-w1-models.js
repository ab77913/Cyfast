...
module.exports = function (sequelize, DataTypes) {
  ...
  const models = {
    ...
    ExecutionCommand: define("ExecutionCommand", "execution_command", { ...id("execution_command_id", DataTypes.STRING(64)), ...org, interactive_session_id: DataTypes.STRING(64), agent_id: DataTypes.STRING(64), command_type: DataTypes.STRING(128), payload: DataTypes.JSON, payload_hash: DataTypes.STRING(64), idempotency_key: DataTypes.STRING(128), expires_at: DataTypes.DATE, status: DataTypes.STRING(32), correlation_id: DataTypes.STRING(64) }),
