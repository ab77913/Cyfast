SELECT 
    ...
    SUM(CASE WHEN T.test_case_no IS NOT NULL THEN 1 ELSE 0 END) AS MappedCount
FROM
    requirement Req 
    LEFT JOIN 
    ...
    (
        ...
        FROM 
            ...
            INNER JOIN 
            (
                SELECT MAX(end_time) AS lastest_end_time, test_case_id, MAX(test_case_execution_id) AS MaxTestCaseExecutionId 
